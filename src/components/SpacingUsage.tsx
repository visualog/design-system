        ...
        <div className="flex flex-col gap-12">
            ...
            <section className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
                    ...
                    >
                        <div className="p-8 bg-white border rounded-md shadow-sm flex gap-4">
                            <div className="bg-green-100 border-2 border-green-400 p-4 rounded text-green-800 flex-1 text-center">Item A</div>
                            <div className="w-4 border-x border-dashed border-gray-400 flex items-center justify-center bg-gray-50 text-xs text-gray-500">Gap</div>
                            <div className="bg-green-100 border-2 border-green-400 p-4 rounded text-green-800 flex-1 text-center">Item B</div>
                        </div>
                    </GuidelineItem>
                </div>
            </section>
