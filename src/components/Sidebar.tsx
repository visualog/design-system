...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 h-screen w-60 bg-white p-4 border-r border-gray-200 z-50 transform md:relative md:translate-x-0 transition-transform duration-300
