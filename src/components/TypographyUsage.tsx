        ...
        <div className="flex flex-col gap-12">
            <section className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
                    ...
                    >
                        <div className="flex flex-col gap-4 w-full px-8 bg-card border rounded-md p-6">
            ...
            <section className="flex flex-col gap-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-12">
                    ...
                    >
                        <div className="w-full bg-card border rounded-md p-6 text-left">
                    ...
                    >
                        <div className="w-full bg-card border rounded-md p-6 text-center">
                            <p className="text-sm leading-relaxed">
                                텍스트를 가운데 정렬하면<br />
