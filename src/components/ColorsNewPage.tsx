...
const ColorsNewPage: React.FC = () => {
    ...
    const tabs = [
        {
            ...
            content: (
                <div className="doc-content-stack">
                    ...
                    >
                        <PrinciplesSection items={colorPrinciples} variant="list" />
                    </DocSection>
                    ...
                    <DocSection
                        ...
                        contentClassName="doc-content-stack"
                    >
                        <div className="doc-content-stack">
                            <DoDontContainer>
                                <DoDont
    ...
    return (
        <FoundationPageLayout
            title="Colors Beta"
            description="개선된 컬러 시스템 문서를 베타로 검토합니다. 접근성과 일관성을 기준으로 색상 역할과 토큰 사용 규칙을 확인할 수 있습니다."
